...
mixin _$HomeController on _HomeControllerBase, Store {
  ...
  List<Item> get listFiltered =>
      (_$listFilteredComputed ??= Computed<List<Item>>(() => super.listFiltered,
  ...
  @override
  ObservableList<Item> get listItems {
    _$listItemsAtom.reportRead();
    return super.listItems;
  }

  @override
  set listItems(ObservableList<Item> value) {
